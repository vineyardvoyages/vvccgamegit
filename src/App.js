...
import { getFirestore, doc, setDoc, getDoc, updateDoc, onSnapshot, arrayUnion, arrayRemove } from 'firebase/firestore'; 

// Firebase Configuration (reads from Netlify Environment Variables)
...
const WINE_VARIETALS = [
  ...
  { name: "Cabernet Franc", country: "France" },
...
const WINE_QUIZ_QUESTIONS = [
  {
    question: "Which grape varieties are primarily used in Bordeaux red wines?",
    options: [
      "Cabernet Sauvignon, Merlot, Cabernet Franc",
      "Pinot Noir, Chardonnay, Sauvignon Blanc",
      "Syrah, Grenache, Mourvèdre",
      "Zinfandel, Malbec, Petite Sirah"
    ],
    correctAnswer: "Cabernet Sauvignon, Merlot, Cabernet Franc",
    explanation: "Bordeaux red wines are primarily blends of Cabernet Sauvignon, Merlot, and Cabernet Franc grapes, which contribute to their distinctive flavor profiles."
  },
  {
  ...
  {
    question: "Which red grape varietal is often referred to as thriving in Virginia's climate?",
      ...
      if (docSnap.exists()) {
        ...
        if (!players.some(p => p.id === userId)) {
          await updateDoc(gameDocRef, { 
            players: arrayUnion({ id: userId, score: 0, userName: userName })
          });
        }
